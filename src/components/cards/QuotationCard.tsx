...
function QuotationCard({ projectId, bidPercentage, clientDetails, companyAddresses, approvedBudget, initialData, onSaveSuccess }: QuotationCardProps) {
  ...
  const handleExportPDF = async () => {
    ...
    // Use shared PDF export function
    try {
      exportQuotationPDF({
        quoteNo,
        clientDetails: {
          companyName: currentClientDetails.companyName,
          tinNumber: currentClientDetails.tinNumber,
          address: currentClientDetails.address,
          contactPerson: currentClientDetails.contactPerson,
          contactNumber: currentClientDetails.contactNumber,
        },
        deliveryAddress: currentFormData.deliveryAddress,
        paymentTerm: currentFormData.paymentTerm,
        deliveryTerm: currentFormData.deliveryTerm,
        ...
        totalBidPrice: currentFinancials.totalBidPrice,
